    ...
    $.extend(RowReorder.prototype, {
        ...
        _mouseDown: function (e, target) {
            ...
            this.s.scroll = {
                ...
                dtLeft: scrollWrapper.length
                    ? scrollWrapper.offset().left
                    : null,
                dtHeight: scrollWrapper.length
                    ? scrollWrapper.outerHeight()
                    : null,
                dtWidth: scrollWrapper.length
                    ? scrollWrapper.outerWidth()
                    : null,
            };
        ...
        _mouseMove: function (e) {
            ...
            if (cancelable) {
                ...
                this.s.dropAllowed = this._rectanglesIntersect(
                    bodyArea,
                    cloneArea
                );
                ...
                this.s.scrollInterval = setInterval(function () {
                    ...
                    if (scroll.windowVert) {
                        ...
                        if (top !== $(document).scrollTop()) {
                            var move = parseFloat(
                                that.dom.cloneParent.css("top")
                            );
                            that.dom.cloneParent.css(
                                "top",
                                move + scroll.windowVert
                            );
                        }
                    }
